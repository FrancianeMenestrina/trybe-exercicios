...
for (let index = 0; index < array.length; index+=1) {
  ...
  // console.log("original " + array[index] + " contador " + contador)
  if (contador > numerocommaiorcontador){
      numerocommaiorcontador = array[index]
  }
}
  
return numerocommaiorcontador
}
console.log(contaNumerosRepetidos([2, 3, 2, 5, 8, 2, 3]))