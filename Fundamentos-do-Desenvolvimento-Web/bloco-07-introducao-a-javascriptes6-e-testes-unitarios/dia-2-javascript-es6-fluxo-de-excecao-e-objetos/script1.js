...
// 1-Crie uma função para adicionar o turno da noite na lesson2 . Essa função deve possuir três parâmetros, sendo eles: 
  ...
  // Ao executar o comando console.log(allLessons) , a saída deverá ser a seguinte:
   ...
   const getNumberOfStudents = (objeto) => {
    ...
    for (let index = 0; index < array.length; index += 1) {
      total = total + objeto[array[index]].numeroEstudantes;
    }
    return total;
  };
